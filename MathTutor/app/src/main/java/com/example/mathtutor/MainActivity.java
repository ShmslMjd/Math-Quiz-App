...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //when user launch the app, go to res folder
        //go to layout folder, get activity main xml file
        //get all the UI components and setup on the screen
    ...
    //when the user start the game or when the user clck play again
    public void playAgain(View view) {
        ...
        //we need to add timer here, the user only has 30 seconds to attempt the quiz
        //within 30 seconds the user must attempt as much question correctly
        //to earn the score
    ...
    public void generateQuestion() {
        ...
        Random rand = new Random(); // create objects

        int a = rand.nextInt(21);
        // generate 2 random numbers, int a and b from 1 to 20
        int b = rand.nextInt(21);

        // convert int a and b to string first, display them at the label or textview
        sumTextView.setText(Integer.toString(a) + " + " + Integer.toString(b));

        locationOfCorrectAnswer = rand.nextInt(4);
        // we have 4 button at here, generate the correct answers
        //the correct answer could be 0,1,2,3 only

        answers.clear();
        // clear the arraylist, why, the previous game questions and answers details
        ...
        //the above loop will calculate 4 different answers
        //stored in the answer array list as item 0,1,2,3
        //and then assign these value to all the four button
